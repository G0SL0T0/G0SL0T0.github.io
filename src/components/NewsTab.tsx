...
const newsData = [
  {
    date: '2025-08-16',
    version: 'v4.0.0',
    text: 'Полный рефакторинг и миграция сайта на TypeScript. (React). Работа через компоненты и удобная маштабируемость статик TSX'
  },  
  {
    date: '2025-08-13',
    version: 'v3.4',
...
export default function NewsTab() {
  ...
  return (
    <>
      <button id="newsTab" className="news-tab" onClick={openModal} aria-label="Последние обновления">
        <span>Новости</span>
        <small>v3.4</small>
      </button>

      {isModalOpen && (
        <div id="newsModal" className="news-modal show" role="dialog" aria-modal="true" aria-labelledby="newsTitle">
          <div className="news-modal__glass">
            ...
            <ul className="news-timeline" id="allNewsList">
